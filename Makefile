...
OFILES = main.o myLib.o font.o breakoutStart.o breakoutGame.o breakoutGameOver.o breakoutWin.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h breakoutStart.h breakoutGame.h breakoutGameOver.h breakoutWin.h
